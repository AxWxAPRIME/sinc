#!/bin/bash
clear
echo -e "\033[1;36mINSTALANDO O SINCRONIZADOR DO PAINEL WEB A.I\033[0m"
...
wget https://github.com/AxWxAPRIME/sinc/raw/main/sincarm/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/AxWxAPRIME/sinc/raw/main/sincarm/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/AxWxAPRIME/sinc/raw/main/sincarm/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://github.com/AxWxAPRIME/sinc/raw/main/sincarm/sincpainel.zip > /dev/null 2>&1
